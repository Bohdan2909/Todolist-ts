...
import {setAppStatusAC, SetErrorType, SetStatusType} from './appReducer';
...
// types
export type AuthReducerActionsType = ReturnType<typeof setIsLoggedInAC> | SetStatusType | SetErrorType
